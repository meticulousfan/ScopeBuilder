<template>
    <div class="section-inner">
        <validation-observer ref="observer" v-slot="{ handleSubmit }">
            <b-form @submit.stop.prevent="handleSubmit(saveSeventh)">
                <input
                    type="hidden"
                    id="project-step"
                ...
                <div class="section-footer">
                    ...
                    <div class="footer-block">
                        <button class="btn" :disabled="disableSubmitButton" value="Add New Project" type="submit">{{saving ? "Submitting..." : "Add New Project"}}</button>
                    </div>
                </div>
            </b-form>
        </validation-observer>
...
export default {
    ...
    methods: {
        ...
        saveSeventh() {
            EventBus.$emit("save-form-clicked")
        },

        goToSixth() {
            EventBus.$emit("goToSixthForm-clicked");
        },
    },
};
</script>
