        ...
        <div class="container">
            <div class="header-inner">
                <div class="header-block with-menu-opener">
                    ...
                    <h1 class="page-caption">Payment Settings</h1>
                </div>
            </div>
        </div>
    </header>
            ...
            <section class="default-section with-footer">
                <div class="container">
                    <div class="section-inner">
                        ...
                        @endif
                        <!-- form -->
                        <form action="{{ route('developer.profile.update.payment') }}" method="POST">
                            @csrf
                            <div class="page-tab">
                                <div class="section-caption">
                                    <h2 class="sc-title">Payment Methods</h2>
                                </div>
                                                ...
                                                <div class="form-fields">
                                                    <div class="form-field">
                                                        <div class="input-field">
                                                            <div class="field-label">PayPal Email Address</div>
                                                            <input type="email" value="{{ Auth::user()->paypal_email }}"
                                                                name="paypal_email">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-field">
                                                        <div class="input-field">
                                                            <div class="field-label">Payoneer Email Address</div>
                                                            <input type="email" value="{{ Auth::user()->payoneer_email }}"
                                                                name="payoneer_email">
                                                        </div>
                                                    </div>
                                                </div>
