        ...
        <div class="sidebar-section">
            <div class="user-block">
                <div class="user-avatar">
                    <img src="{{ !empty(Auth::user()->getFirstMediaUrl('avatar', 'thumb')) ? Auth::user()->getFirstMediaUrl('avatar', 'thumb') : asset('ui_assets/img/content-images/user-avatar.jpg') }}" alt="{{ Auth::user()->name }}">
                </div>
        ...
        <div class="sidebar-section">
            ...
            <nav class="sidebar-nav">
                <ul>
                    ...
                    <li>
                        <a href="{{ route('developer.project_list') }}">
                            <svg class="link-icon">
                                <use xlink:href="{{ asset('ui_assets/img/icons-sprite.svg#tiles') }}"></use>
                            </svg>
                    ...
                    <li>
                        <a href="{{ route('developer.payouts') }}">
                            <svg class="link-icon">
