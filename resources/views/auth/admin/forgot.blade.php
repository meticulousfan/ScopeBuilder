...
@section('content')
    <div class="auth-page">
        ...
        <div class="auth-block">
            <div class="page-nav">
                <ul>
                    <li><a href="{{ route('admin.login.form') }}">Sign In</a></li>
                </ul>
            </div>
                    ...
                    <div class="form-fields">
                        <div class="form-field">
                            <div class="input-field">
                                ...
                                <a href="{{ route('admin.login.form') }}" class="login-link" style="right: 16px; top: 16px; color: var(--blue-800); position: absolute;">Login</a>
