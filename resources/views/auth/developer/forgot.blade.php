...
@section('content')
    <div class="auth-page">
        ...
        <div class="auth-block">
            <div class="page-nav">
                <ul>
                    <li><a href="{{ route('developer.login.form') }}">Sign In</a></li>
                    <li><a href="{{ route('developer.register.form') }}">Create An Account</a></li>
                </ul>
            </div>
            ...
            <form method="POST" action="{{ route('developer.forgot') }}">
                @csrf
                    ...
                    <div class="form-fields">
                        <div class="form-field">
                            <div class="input-field">
                                ...
                                <a href="{{ route('developer.login.form') }}" class="login-link" style="right: 16px; top: 16px; color: var(--blue-800); position: absolute;">Login</a>
