...
@section('page-title')
    @if($mode_type=='edit') Edit New Project
    @elseif($mode_type=='create') Add New Project
    @endif
@endsection
...
@php
    ...
    if($mode_type=='edit'){
        $form_action = route('client.projects.update',$project->uuid);
    } else{
        $form_action = route('client.projects.store');
    }
            ...
            <div class="header-inner px-3">
                <div class="header-block with-menu-opener">
                    ...
                    <h1 class="page-caption font-weight-bold">
                        @if($mode_type=='edit')
                        <span class="show-on-mobile">{{ __('frontend.edit_new_mobile_project') }}</span>
                ...
                <div class="buttons pr-3">
                    <button type="button" value="Save For Later" class="btn btn-primary later-h-btn d-none" id="@if(!auth()->check()){{ 'savelater' }}@endif">Save For Later</button>
                </div>
            </div>
        </div>
    </header>
                                    ...
                                    <div class="question-block">
                                        ...
                                        <form action="{{ $form_action }}" method="POST" data-formid="step_no_4" class="projectforms form" @if($mode_type=='edit' && $project->is_draft && $project->left_step==4) style="display:block;" @else style="display:none;" @endif>
                                          @csrf
                                            ...
                                            <div class="row block-top">
                                                <div class="col">
                                                    <h3 class="block-caption">Define the pages of this project.</h3>
                                                </div>
                                                <div class="col-auto">
                                                   <div class="popover-block">
                                                        <span class="block-opener">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-caption">
                ...
                @if(!auth()->check()) <p class="mc-subtitle">Register Now to Proceed.</p>@endif
            </div>
            ...
            <div class="modal-footer">
                @if(!auth()->check())
                    <a id="registerBtn" href="/" class="btn">Proceed To Register</a>
                @else
                    <a id="paymentBtn" href="{{ route('client.projects') }}" class="btn">Proceed To Payment</a>
                @endif
            </div>
        </div>
    </div>
