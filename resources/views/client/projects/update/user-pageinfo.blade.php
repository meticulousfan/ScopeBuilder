    ...
    @if(count($pagesInformation))
        @foreach($pagesInformation as $page) 
            ...
            @foreach($users as $user)
                ...
                @endphp
                <div class="card card-project" @php if($row_number>1) echo 'style="display: none;"'; @endphp data-number="{{$row_number}}">
                                                                ...
                                                                @foreach($information as $info)
                                                                    <div class="values-list informationfield" id="{{$uniqueId+$loop->index}}">
                                                                        <div class="item">
                                                                            ...
                                                                            <button type="button" class="action-btn rminfofield @if($loop->first) d-none2 @else mt-3 @endif" data-id="{{$uniqueId+$loop->index}}">
