                        ...
                        <td>
                            <table width="400px" border="0" align="left" cellpadding="0" cellspacing="0" style="padding: 0; margin-bottom: 10px;">
                               <tr>
                                 ...
                                 <td align="right" style="text-align: right; font-size: 14px; border: 1px dotted #dee2e6; border-left: 0px; padding: 15px;">{{ $data->created_at }}</td>
                              </tr>
                            </table>
                        </td>
                     </tr>
                        ...
                        <td>
                            <table width="400px" border="0" align="left" cellpadding="0" cellspacing="0" style="padding: 0; margin-bottom: 10px;">
                               <tr>
                                 ...
                                 <td align="right" style="text-align: right; font-size: 14px; border: 1px dotted #dee2e6; border-left: 0px;   padding: 15px;">{{ $data->type == 'both' ? 'Web & Mobile' : $data->type }}</td>
                              </tr>
                            </table>
                        </td>
                     </tr>
